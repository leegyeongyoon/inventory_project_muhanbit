...
<body>
	...
	<button type="button" class="btn btn-success col-sm-12" data-toggle="collapse" data-target="#demo1" style="margin-bottom: 2em;">데이터베이스 복구하기</button>
	...
	<button type="button" class="btn btn-success col-sm-12" data-toggle="collapse" data-target="#demo" style="margin-bottom: 2em;">데이터 복구하기</button>
