...
<%
	...
	String data = "		<thead class='thead-dark'><tr><th>선택</th> <th>카테고리</th> <th>물건명</th> <th>시리얼번호</th> <th>입고일</th> <th>기타사항</th></tr></thead>";
		...
		PreparedStatement pstmt = conn.prepareStatement("SELECT p.category,i.product_name , i.serial_number , i.input_date , i.other_information FROM product_tbl p INNER JOIN inventory_tbl i ON p.product_name = i.product_name WHERE i.product_name = ? ORDER BY input_date,serial_number DESC");
